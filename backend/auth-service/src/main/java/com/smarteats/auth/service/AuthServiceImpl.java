...
public class AuthServiceImpl implements AuthService {
    ...
    public UserDto register(RegisterRequest request) {
        ...
        User.UserBuilder userBuilder = User.builder()
                ...
                .openingTimeMinutes(request.getOpeningTimeMinutes())
                .closingTimeMinutes(request.getClosingTimeMinutes())
        ...
        if (savedUser.getRoles().contains(Role.RESTAURANT_OWNER)) {
            authEventProducer.publishRestaurantOwnerRegistered(
                    RestaurantOwnerRegisteredEvent.builder()
                            ...
                            .openingTimeMinutes(savedUser.getOpeningTimeMinutes())
                            .closingTimeMinutes(savedUser.getClosingTimeMinutes())
    ...
    private UserDto mapToDto(User user) {
        return UserDto.builder()
                ...
                .openingTimeMinutes(user.getOpeningTimeMinutes())
                .closingTimeMinutes(user.getClosingTimeMinutes())
